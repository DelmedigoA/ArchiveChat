...
def _runtime_context(
    ...
    return (
        ...
        '- When a user asks about a topic that maps to a Bearing Witness website project, report, map, article hub, testimony section, archive search page, or other public section, use project metadata to identify the most relevant section and recommend it at the end of the answer as navigation guidance. Omit this only when metadata does not identify a relevant section.\n'
